...
export default function VendorReviewsPage() {
  ...
  const handleSendReply = async () => {
    ...
    try {
      // 1. Send the update
      await api.put(`/reviews/vendor/${selectedReview._id}/reply`, {
        reply: replyText,
      });
      ...
      setReviews((prevReviews) =>
        prevReviews.map((review) =>
          review._id === selectedReview._id
            ? { ...review, vendor_reply: replyText } // Update the specific review
            : review,
        ),
      );
    } catch (error) {
            ...
            {reviews.length === 0 ? (
              ...
              reviews.map((review) => (
                ...
                >
                  ...
                  {/* Status */}
                  <TableCell>
                    {/* Check if vendor_reply exists and is not empty */}
                    {review.vendor_reply ? (
